    ...
    <div class="col-xl-10">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            ...
            <span class="badge bg-<?= $statusClass($portalStatus) ?>">
                <?= $escape(ucwords(str_replace('_', ' ', $portalStatus))) ?>
            </span>
        </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <form action="<?= $escape($portalFormAction ?? '') ?>" method="post" enctype="multipart/form-data" class="row g-3">
                            ...
                            <?php foreach (PortalModel::CHECKLIST_ITEMS as $key => $item): ?>
                                <div class="col-md-6">
                            ...
                            <?php if (!$isReadOnly): ?>
                                <div class="col-12 d-grid">
                                    <button type="submit" class="btn btn-success">Enviar cadastro e documentos</button>
                                </div>
                            <?php endif; ?>
                        </form>
                    </div>
