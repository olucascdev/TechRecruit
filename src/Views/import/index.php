...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    <div>
        <h1 class="h3 mb-1">Importacoes</h1>
        <p class="text-muted mb-0">Importe planilhas de tecnicos em formato Excel.</p>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <div class="row align-items-center g-3">
            <div class="col-lg-7">
                <h2 class="h5 mb-1">Nova importacao</h2>
                <p class="text-muted mb-0">Arquivos aceitos: `.xlsx` e `.xls`, com tamanho maximo de 10MB.</p>
            </div>
            <div class="col-lg-5">
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <h2 class="h5 mb-3">Historico de batches</h2>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <?php if ($batches === []): ?>
                    <tr>
                        <td colspan="7" class="text-center text-muted py-4">Nenhuma importacao registrada.</td>
                    </tr>
                <?php else: ?>
